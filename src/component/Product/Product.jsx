        ...
        <div className="page-wrapper">
                                        ...
                                        <tbody>
                                            {
                                                products && products.map((value, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{new Intl.NumberFormat('vi-VN',{style: 'decimal',decimal: '$'}).format(value.price_product)+ ' $'}</td>
            ...
            <footer className="footer text-center text-muted">
                All Rights Reserved by Adminmart. Designed and Developed by <a
                    href="https://www.facebook.com/profile.php?id=100025138370730">Toàn Tài</a>.
            </footer>
        </div>
    );
}
